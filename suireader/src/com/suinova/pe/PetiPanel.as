package com.suinova.pe 
{
	...
	public class PetiPanel extends Sprite
	{
		 ...
		 * @param	ctrl
		 */
		public function addControl(ctrl: DisplayObject, align: String = 'center'): void
		{
			_controls.push(ctrl);
	...
	//trace('right align control here');
		...
		public function addControls(lst: Array, align: String = 'center'): void
		{
	...
	//trace('PetiPanel.addControls: set ctrl[', i, '].x=', ctrl.x, ',y=', ctrl.y,'dim=',ctrl.width,ctrl.height);
		 ...
		 * @param	align
		 */
		public function addText(txt: String, params: Object = null, align: String = 'center'): void
		{
