package
{
    ...
    public class PurchaseBox extends PetiPanel
    {
        ...
        public function PurchaseBox(vgs:Array,w:int=400,h:int=380)
        {
        ...
        private function addrow(idx:int, vgid:int, vgname:String, vgprice:Number, vgnote:String):void
        {
			...
			var left:PetiPanel = new PetiPanel(80, 100, false, false);
            ...
            //name and note
			var right:PetiPanel = new PetiPanel(_width - 110, 100, false, false);
